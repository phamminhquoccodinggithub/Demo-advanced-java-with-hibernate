...
public class JdbcDemo {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/demodatabase", "root", "");

        //Step 3: Statement, PrepareStatement, CallableStatement
        ...
        //        Statement stm = conn.createStatement()
        CallableStatement stm = conn.prepareCall("{ CALL count_prod_by_cate(?, ?)}");
        stm.setInt(1, 3);
